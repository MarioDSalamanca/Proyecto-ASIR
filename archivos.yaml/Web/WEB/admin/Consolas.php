...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <form action="Consolas.php" method="post" enctype="multipart/form-data">
                <div class="botones">
            ...
            <div class="cuerpo">
                ...
                <?php
                    ...
                    $query = "select * from Consolas order by empresa";
                    ...
                    if ($rows > 0) {
                        ...
                        for ($i = 0; $i < $rows; $i++) {
                            ...
                            echo "<form action='Consolas.php' method='post'>";
                            echo "<tr>";
                                echo "<td width='7%'>";
                                ...
                                # Subir foto al servidor
                                    ...
                                    # Para evitar la unicidad de nombre se añade una marca de tiempo
                                        ...
                                        if (is_uploaded_file($_FILES['imagen']['tmp_name'])) {
                                            $nombreDirectorio = "../Fotos_Productos/Consolas/";
                                        ...
                                        if ($_FILES['imagen']['name'] == "") {
                                            ...
                                            if (strlen($nombre) > 2 && strlen($especificación) > 2 && !empty($precio) && !empty($empresa) && !empty($cantidad)) {
                                                ...
                                                # Conexión con el servidor
                                                    ...
                                                    $query = "insert into Consolas values (null, '$nombre', '$especificación', '$precio', '$empresa', '$cantidad', '$nombreFichero', '$tabla')";
                                                    // echo $query;
                        ...
                        # Editar una fila
                            if (isset($_REQUEST['editar'])) {
                                ...
                                echo "    <form action='Consolas.php' method='post' enctype='multipart/form-data'>";
                                        ...
                                        # No se ha introducido ningún fichero
                                            ...
                                            if (strlen($nombre) > 2 && strlen($especificación) > 2 && !empty($precio) && !empty($empresa) && !empty($cantidad)) {
                                                ...
                                                if ($copiaFichero) {
                                                    ...
                                                    $query = "update Consolas set nombre = '$nombre', especificación = '$especificación', precio= '$precio', empresa = '$empresa', cantidad = '$cantidad', imagen = '$nombreFichero', tabla = '$tabla' where especificación = '".$_REQUEST['especificación']."'";
                                                    // echo $query;
                                                    if(mysqli_query($conexion,$query)) {
                                                        ?>
                            ...
                            # Eliminar un producto
                                ...
                                if (isset($_REQUEST['confirmar'])) {
                                    ...
                                    $query = "delete from Consolas where especificación like '".$_REQUEST['especificación']."'";
                                    $consulta = mysqli_query($conexion, $query);
