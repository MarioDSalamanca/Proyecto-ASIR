    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Kingston Fury Impact DDR4 64GB'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Memorias-RAM-P.php">&#10150;</a></p>
            <form action="Kingston Fury Impact DDR4 64GB.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/SO-DIMM/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Corsair Mac Memory DDR4 64GB.php"><img src="../../Fotos_Productos/SO-DIMM/Corsair Mac Memory DDR4 64GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Corsair Mac Memory DDR4 64GB</p></a>
                    </td>
                    <td>
                        <a href="Kingston Fury Impact DDR5 32GB.php"><img src="../../Fotos_Productos/SO-DIMM/Kingston Fury Impact DDR5 32GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Kingston Fury Impact DDR5 32GB</p></a>
                    </td>
                    <td>
                        <a href="PNY Performance DDR4 16GB.php"><img src="../../Fotos_Productos/SO-DIMM/PNY Performance DDR4 16GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">PNY Performance DDR4 16GB</p></a>
                    </td>
                    <td>
                        <a href="Crucial DDR4 16GB.php"><img src="../../Fotos_Productos/SO-DIMM/Crucial DDR4 16GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Crucial DDR4 16GB</p></a>
                    </td>
                </tr>
            </table>
        </main>
