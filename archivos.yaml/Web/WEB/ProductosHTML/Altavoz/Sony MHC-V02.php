    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Sony MHC-V02'";
            ...
            <form action="Sony MHC-V02.php" method="post" class="formprod">
            ...
            <table class="similares">
                ...
                <tr>
                    ...
                    <td>
                        <a href="Polk Reserve R600.jpg"><img src="../../Fotos_Productos/Altavoz/Polk Reserve R600.jpg" class="imgsimilares">
                        <p class="prodsimilares">Polk Reserve R600</p></a>
                    </td>
                    <td>
                        <a href="Sony MHC-V73D.jpg"><img src="../../Fotos_Productos/Altavoz/Sony MHC-V73D.jpg" class="imgsimilares">
