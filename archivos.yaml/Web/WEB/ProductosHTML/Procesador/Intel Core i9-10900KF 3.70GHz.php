    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Intel Core i9-10900KF 3.70GHz'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/CPU.php">&#10150;</a></p>
            <form action="Intel Core i9-10900KF 3.70GHz.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Procesador/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Intel Core i5-12400F 4.4GHz.php"><img src="../../Fotos_Productos/Procesador/i5-12g.jpg" class="imgsimilares">
                        <p class="prodsimilares">Intel Core i5-12400F 4.4GHz</p></a>
                    </td>
                    <td>
                        <a href="Intel Core i3-12100 4.3GHz.php"><img src="../../Fotos_Productos/Procesador/i3-12g.jpg" class="imgsimilares">
                        <p class="prodsimilares">Intel Core i3-12100 4.3GHz</p></a>
                    </td>
                    <td>
                        <a href="AMD Ryzen 5 7600X 4.7GHz.php"><img src="../../Fotos_Productos/Procesador/Ryzen5-caro.jpg" class="imgsimilares">
                        <p class="prodsimilares">AMD Ryzen 5 7600X 4.7GHz</p></a>
                    </td>
                    <td>
                        <a href="AMD Ryzen 9 7950X 4.5GHz.php"><img src="../../Fotos_Productos/Procesador/Ryzen9-caro.jpg" class="imgsimilares">
                        <p class="prodsimilares">AMD Ryzen 9 7950X 4.5GHz</p></a>
                    </td>
                </tr>
            </table>
        </main>
