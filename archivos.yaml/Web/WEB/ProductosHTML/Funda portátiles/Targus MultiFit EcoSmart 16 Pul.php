    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Targus MultiFit EcoSmart 16 Pul'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Fundas.php">&#10150;</a></p>
            <form action="Targus MultiFit EcoSmart 16 Pul.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Funda portátiles/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="MSI Prestige 17 Pul.php"><img src="../../Fotos_Productos/Funda portátiles/MSI Prestige 17 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">MSI Prestige 17 Pul</p></a>
                    </td>
                    <td>
                        <a href="Targus MultiFit EcoSmart 16 Pul.php"><img src="../../Fotos_Productos/Funda portátiles/Targus MultiFit EcoSmart 16 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Targus MultiFit EcoSmart 16 Pul</p></a>
                    </td>
                    <td>
                        <a href="Dell Professional 15 Pul.php"><img src="../../Fotos_Productos/Funda portátiles/Dell Professional 15 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Dell Professional 15 Pul</p></a>
                    </td>
                    <td>
                        <a href="Tucano Colore 15.6 Pul.php"><img src="../../Fotos_Productos/Funda portátiles/Tucano Colore 15.6 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Tucano Colore 15.6 Pul</p></a>
                    </td>
                </tr>
            </table>
        </main>
