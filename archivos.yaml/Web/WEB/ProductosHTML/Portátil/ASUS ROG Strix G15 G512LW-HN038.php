    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'ASUS ROG Strix G15 G512LW-HN038'";
            ...
            <form action="ASUS ROG Strix G15 G512LW-HN038.php" method="post" class="formprod">
