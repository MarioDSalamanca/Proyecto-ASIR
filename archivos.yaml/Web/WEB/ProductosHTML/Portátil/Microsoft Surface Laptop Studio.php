    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'Microsoft Surface Laptop Studio'";
            ...
            <form action="Microsoft Surface Laptop Studio.php" method="post" class="formprod">
