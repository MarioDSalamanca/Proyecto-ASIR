    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Crucial Ballistix Max RGB 32GB'";
            ...
            <form action="Crucial Ballistix Max RGB 32GB.php" method="post" class="formprod">
