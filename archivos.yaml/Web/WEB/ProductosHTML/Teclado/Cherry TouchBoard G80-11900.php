    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Cherry TouchBoard G80-11900'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Teclados.php">&#10150;</a></p>
            <form action="Cherry TouchBoard G80-11900.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Teclado/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Logitech Ergo K860.php"><img src="../../Fotos_Productos/Teclado/Logitech Ergo K860.jpg" class="imgsimilares">
                        <p class="prodsimilares">Logitech Ergo K860</p></a>
                    </td>
                    <td>
                        <a href="Cherry TouchBoard G80-11900.php"><img src="../../Fotos_Productos/Teclado/Cherry TouchBoard G80-11900.jpg" class="imgsimilares">
                        <p class="prodsimilares">Cherry TouchBoard G80-11900</p></a>
                    </td>
                    <td>
                        <a href="ASUS W5000.php"><img src="../../Fotos_Productos/Teclado/ASUS W5000.jpg" class="imgsimilares">
                        <p class="prodsimilares">ASUS W5000</p></a>
                    </td>
                    <td>
                        <a href="Apple Magic Keyboard.php"><img src="../../Fotos_Productos/Teclado/Apple Magic Keyboard.jpg" class="imgsimilares">
                        <p class="prodsimilares">Apple Magic Keyboard</p></a>
                    </td>
                </tr>
            </table>
        </main>
