...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Raton.php" method="post">
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'Raton'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Ratón/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                        ...
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'Raton' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'Raton' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'Raton' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'Raton' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
