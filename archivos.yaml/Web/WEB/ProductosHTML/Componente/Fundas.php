...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Fundas.php" method="post">
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'Funda'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Funda portátiles/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                    $query = "select * from Componentes where tipo like 'Funda' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            # Orden por Más barato
                            elseif ($orden == '1') {

                                    $query = "select * from Componentes where tipo like 'Funda' and precio between '$precio1' and '$precio2' order by precio";
                                }
