                ...
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="nintendo" class="empresas"> Nintendo</p>
                            <p><input type="radio" name="empresa" value="videojuego" class="empresas"> Videojuego</p>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    $query = "select * from Consolas where empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query = "select * from Consolas where precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    $query = "select * from Consolas where empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query = "select * from Consolas where precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
