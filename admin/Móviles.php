...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <form action="Móviles.php" method="post" enctype="multipart/form-data">
                <div class="botones">
                    ...
                    <div id="newinsert">
                        ...
                        <input type='text' class='newdatos' name='newtabla' placeholder="tabla" required>
            ...
            <div class="cuerpo">
                ...
                <?php
                    ...
                    $query = "select * from Móviles order by empresa";
                    ...
                    if ($rows > 0) {
                        ...
                        for ($i = 0; $i < $rows; $i++) {
                            ...
                            echo "<form action='Móviles.php' method='post'>";
                            echo "<tr>";
                                echo "<td width='7%'>";
                                ...
                                # Subir foto al servidor
                                    ...
                                    # Para evitar la unicidad de nombre se añade una marca de tiempo
                                        ...
                                        if (is_uploaded_file($_FILES['imagen']['tmp_name'])) {
                                            $nombreDirectorio = "../Fotos_Productos/Móviles/";
                                    ...
                                    # No se ha introducido ningún fichero
                                        ...
                                        if ($_FILES['imagen']['name'] == "") {
                                            ...
                                            if (strlen($nombre) > 2 && !empty($precio) && !empty($empresa) && !empty($cantidad)) {
                                                ...
                                                # Conexión con el servidor
                                                    ...
                                                    $query = "insert into Móviles values (null, '$nombre', '$precio', '$empresa', '$cantidad', '$nombreFichero', '$tabla')";
                                                    // echo $query;
                        ...
                        # Editar una fila
                            if (isset($_REQUEST['editar'])) {
                                ...
                                echo "    <form action='Móviles.php' method='post' enctype='multipart/form-data'>";
                                        ...
                                        # No se ha introducido ningún fichero
                                            ...
                                            if (strlen($nombre) > 2 && !empty($precio) && !empty($empresa) && !empty($cantidad)) {
                                                ...
                                                if ($copiaFichero) {
                                                    ...
                                                    $query = "update Móviles set nombre = '$nombre', precio= '$precio', empresa = '$empresa', cantidad = '$cantidad', imagen = '$nombreFichero', tabla = '$tabla' where nombre = '".$_REQUEST['nombre']."'";
                                                    // echo $query;
                                                    if(mysqli_query($conexion,$query)) {
                                                        ?>
                            ...
                            # Eliminar un producto
                                ...
                                if (isset($_REQUEST['confirmar'])) {
                                    ...
                                    $query = "delete from Móviles where nombre like '".$_REQUEST['nombre']."'";
                                    $consulta = mysqli_query($conexion, $query);
