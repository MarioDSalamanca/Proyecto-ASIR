...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <form action="Portátiles.php" method="post" enctype="multipart/form-data">
                <div class="botones">
            ...
            <div class="cuerpo">
                ...
                <?php
                    ...
                    $query = "select * from Portátiles order by función";
                    ...
                    if ($rows > 0) {
                        ...
                        for ($i = 0; $i < $rows; $i++) {
                            ...
                            echo "<form action='Portátiles.php' method='post'>";
                            echo "<tr>";
                                echo "<td width='7%'>";
                                ...
                                echo "</td>";
                                echo "<td>";
                                    echo "<input type='text' name='función' value='".$bbdd['función']."' readonly>";
                                echo "</td>";
                                echo "<td>";
                                ...
                                # Subir foto al servidor
                                    ...
                                    # Para evitar la unicidad de nombre se añade una marca de tiempo
                                        ...
                                        if (is_uploaded_file($_FILES['imagen']['tmp_name'])) {
                                            $nombreDirectorio = "../Fotos_Productos/PCs/".$función."/";
                                    ...
                                    # No se ha introducido ningún fichero
                                        ...
                                        if ($_FILES['imagen']['name'] == "") {
                                            ...
                                            if (strlen($nombre) > 2 && strlen($especificación) > 2 && !empty($precio) && !empty($empresa) && !empty($cantidad)) {
                                                ...
                                                # Conexión con el servidor
                                                    ...
                                                    $query = "insert into Portátiles values (null, '$nombre', '$especificación', '$precio', '$empresa', '$función', '$cantidad', '$nombreFichero', '$tabla')";
                                                    // echo $query;
                        ...
                        # Editar una fila
                            if (isset($_REQUEST['editar'])) {
                                ...
                                echo "    <form action='Portátiles.php' method='post' enctype='multipart/form-data'>";
                                ...
                                echo "                Función:<select name='editfunción' class='inputedit'>";
                                                        if ($_REQUEST['función'] == 'WorkStation') {
                                echo "                      <option value='WorkStation'>WorkStation</option>";
                                echo "                      <option value='Gaming'>Gaming</option>";
                                                        }
                                                        elseif ($_REQUEST['función'] == 'Gaming') {
                                echo "                      <option value='Gaming'>Gaming</option>";
                                echo "                      <option value='WorkStation'>WorkStation</option>";
                                                        }
                                echo "                </select><br>";
                                echo "                <input type='hidden' name='tamaño' value='100000'>";
                                echo "                Imagen:<input type='file' class='fileedit' name='editimagen' value='".$_REQUEST['imagen']."'>";
                                ...
                                if (isset($_REQUEST['modificar'])) {
                                    ...
                                    # Subir foto al servidor
                                        ...
                                        # No se ha introducido ningún fichero
                                            ...
                                            if (strlen($nombre) > 2 && strlen($especificación) > 2 && !empty($precio) && !empty($empresa) && strlen($función) > 2 && !empty($cantidad)) {
                                                
                                                if ($copiaFichero) {
                                                    move_uploaded_file($_FILES['editimagen']['tmp_name'], $nombreDirectorio . $nombreFichero);
                                                }
                                
                                                    $query = "update Portátiles set nombre = '$nombre', especificación = '$especificación', precio= '$precio', empresa = '$empresa', función = '$función', cantidad = '$cantidad', imagen = '$nombreFichero', tabla = '$tabla' where especificación = '".$_REQUEST['especificación']."'";
                                                    // echo $query;
                                                    if(mysqli_query($conexion,$query)) {
                                                        ?>
                            ...
                            # Eliminar un producto
                                ...
                                if (isset($_REQUEST['confirmar'])) {
                                    ...
                                    $query = "delete from Portátiles where especificación like '".$_REQUEST['especificación']."'";
                                    $consulta = mysqli_query($conexion, $query);
