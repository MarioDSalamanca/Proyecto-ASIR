...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <form action="PCs.php" method="post" enctype="multipart/form-data">
                <div class="botones">
            ...
            <div class="cuerpo">
                ...
                <?php
                    ...
                    $query = "select * from PCs order by función";
                    ...
                    if ($rows > 0) {
                        ...
                        for ($i = 0; $i < $rows; $i++) {
                            ...
                            echo "<form action='PCs.php' method='post'>";
                            echo "<tr>";
                                echo "<td width='7%'>";
                                        ...
                                        if ($_FILES['imagen']['name'] == "") {
                                            ...
                                            if (strlen($nombre) > 2 && strlen($especificación) > 2 && !empty($precio) && !empty($empresa) && !empty($cantidad)) {
                                                ...
                                                # Conexión con el servidor
                                                    ...
                                                    $query = "insert into PCs values (null, '$nombre', '$especificación', '$precio', '$empresa', '$función', '$cantidad', '$nombreFichero', '$tabla')";
                                                    // echo $query;
                        ...
                        # Editar una fila
                            if (isset($_REQUEST['editar'])) {
                                ...
                                echo "    <form action='PCs.php' method='post' enctype='multipart/form-data'>";
                                        ...
                                        # No se ha introducido ningún fichero
                                            ...
                                            if (strlen($nombre) > 2 && strlen($especificación) > 2 && !empty($precio) && !empty($empresa) && strlen($función) > 2 && !empty($cantidad)) {
                                                ...
                                                if ($copiaFichero) {
                                                    ...
                                                    $query = "update PCs set nombre = '$nombre', especificación = '$especificación', precio= '$precio', empresa = '$empresa', función = '$función', cantidad = '$cantidad', imagen = '$nombreFichero', tabla = '$tabla' where especificación = '".$_REQUEST['especificación']."'";
                                                    // echo $query;
                                                    if(mysqli_query($conexion,$query)) {
                                                        ?>
                            ...
                            # Eliminar un producto
                                ...
                                if (isset($_REQUEST['confirmar'])) {
                                    ...
                                    $query = "delete from PCs where especificación like '".$_REQUEST['especificación']."'";
                                    $consulta = mysqli_query($conexion, $query);
