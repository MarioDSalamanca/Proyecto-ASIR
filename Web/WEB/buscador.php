...
<div class="buscadorResult">
    ...
    if ($consulta !== false) {
        ...
        while ($resultado = mysqli_fetch_assoc($consulta)) {
            ...
            echo "<a href='/PHP/Web/WEB/ProductosHTML/".$resultado['tabla']."/".$resultado['nombre'].".php'><p><table><tr><td width='10%'><img class='imgbuscador' src='/PHP/Web/WEB/Fotos_Productos/".$resultado['tabla'].'/'.$resultado['imagen']."'.jpg ></td><td>".$resultado['nombre']." - ".$resultado['precio']."€</td></tr></table></p></a>";
