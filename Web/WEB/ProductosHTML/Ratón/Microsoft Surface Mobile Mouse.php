    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Microsoft Surface Mobile Mouse'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Ratones.php">&#10150;</a></p>
            <form action="Microsoft Surface Mobile Mouse.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Ratón/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Logitech M325.php"><img src="../../Fotos_Productos/Ratón/Logitech M325.jpg" class="imgsimilares">
                        <p class="prodsimilares">Logitech M325</p></a>
                    </td>
                    <td>
                        <a href="Microsoft Wireless Mouse.php"><img src="../../Fotos_Productos/Ratón/Microsoft Wireless Mouse.jpg" class="imgsimilares">
                        <p class="prodsimilares">Microsoft Wireless Mouse</p></a>
                    </td>
                    <td>
                        <a href="ASUS ROG Gladius III.php"><img src="../../Fotos_Productos/Ratón/ASUS ROG Gladius III.jpg" class="imgsimilares">
                        <p class="prodsimilares">ASUS ROG Gladius III</p></a>
                    </td>
                    <td>
                        <a href="Trust Siero.php"><img src="../../Fotos_Productos/Ratón/Trust Siero.jpg" class="imgsimilares">
                        <p class="prodsimilares">Trust Siero</p></a>
                    </td>
                </tr>
            </table>
        </main>
