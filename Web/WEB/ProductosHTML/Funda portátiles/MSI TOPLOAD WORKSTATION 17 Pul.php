    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'MSI TOPLOAD WORKSTATION 17 Pul'";
            ...
            <form action="MSI TOPLOAD WORKSTATION 17 Pul.php" method="post" class="formprod">
