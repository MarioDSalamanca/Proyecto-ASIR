    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Consolas where nombre like 'Nintendo Switch+Mario Kart 8'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Consola/Consolas.php">&#10150;</a></p>
            <form action="Nintendo Switch+Mario Kart 8.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Consola/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="./Fifa 23.php"><img src="../../Fotos_Productos/Consola/Fifa 23.jpg" class="imgsimilares">
                        <p class="prodsimilares">Fifa 23</p></a>
                    </td>
                    <td>
                        <a href="./Sony PS5 DualSense.php"><img src="../../Fotos_Productos/Consola/Sony PS5 DualSense.jpg" class="imgsimilares">
                        <p class="prodsimilares">Sony PS5 DualSense</p></a>
                    </td>
                    <td>
                        <a href="Microsoft Xbox Series S.php"><img src="../../Fotos_Productos/Consola/Microsoft Xbox Series S.jpg" class="imgsimilares">
                        <p class="prodsimilares">Microsoft Xbox Series S</p></a>
                    </td>
                    <td>
                        <a href="Minecraft.php"><img src="../../Fotos_Productos/Consola/Minecraft.jpg" class="imgsimilares">
                        <p class="prodsimilares">Minecraft</p></a>
                    </td>
                </tr>
            </table>
        </main>
