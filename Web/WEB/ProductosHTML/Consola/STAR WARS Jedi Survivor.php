    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Consolas where nombre like 'STAR WARS Jedi Survivor'";
            ...
            <form action="STAR WARS Jedi Survivor.php" method="post" class="formprod">
                ...
                <div class="producto">
                    ...
                    <div class="divproductos">
                        ...
                        <p class="coloresprod">
                            <strong>Compañía</strong> <i>(Sony por defecto)</i>:
                        </p>
                        <div class="botonescoloresprod">
                            <input type="radio" name="almacenamiento" id="almacenamiento500" value="Sony" checked>
                            <label for="almacenamiento500" class="almacenamiento">Sony</label>
                            <input type="radio" name="almacenamiento" id="almacenamiento1" value="Xbox">
                            <label for="almacenamiento1" class="almacenamiento">Xbox</label>
                            <input type="radio" name="almacenamiento" id="almacenamiento2" value="Nintendo Switch">
                            <label for="almacenamiento2" class="almacenamiento">N Switch</label>
                        </div>
...
<?php
        ...
        if (isset($_REQUEST['añadir']) && $_SESSION['correo'] != null) {
            ...
            $_SESSION['carrito'][$producto]['Consola'] = $almacenamiento;
