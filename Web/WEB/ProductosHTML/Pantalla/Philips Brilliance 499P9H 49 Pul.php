    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Philips Brilliance 499P9H 49 Pul'";
            ...
            <form action="Philips Brilliance 499P9H 49 Pul.php" method="post" class="formprod">
