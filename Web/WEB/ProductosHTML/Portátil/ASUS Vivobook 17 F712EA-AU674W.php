    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'ASUS Vivobook 17 F712EA-AU674W'";
            ...
            <form action="ASUS Vivobook 17 F712EA-AU674W.php" method="post" class="formprod">
