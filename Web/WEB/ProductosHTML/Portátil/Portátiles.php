...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Portátiles.php" method="post">
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="Apple" class="empresas"> Apple</p>
                            <p><input type="radio" name="empresa" value="HP" class="empresas"> HP</p>
                            <p><input type="radio" name="empresa" value="Microsoft" class="empresas"> Microsoft</p>
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($modelo)) {
                                    if (!empty($empresa)) {
                                        ...
                                        $query = "select * from Portátiles where función like '$modelo' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    else {

                                        $query = "select * from Portátiles where función like '$modelo' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                }
                                else {
                                    if (!empty($empresa)) {

                                        $query = "select * from Portátiles where empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    else {

                                        $query = "select * from Portátiles where precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($modelo)) {
                                    if (!empty($empresa)) {
                                        ...
                                        $query = "select * from Portátiles where función like '$modelo' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    else {

                                        $query = "select * from Portátiles where función like '$modelo' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                }
                                else {
                                    if (!empty($empresa)) {

                                        $query = "select * from Portátiles where empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    else {

                                        $query = "select * from Portátiles where precio between '$precio1' and '$precio2' order by precio";
                                    }
                                }
                            }
