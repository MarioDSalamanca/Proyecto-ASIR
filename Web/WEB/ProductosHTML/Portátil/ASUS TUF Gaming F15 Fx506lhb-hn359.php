    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'ASUS TUF Gaming F15 Fx506lhb-hn359'";
            ...
            <form action="ASUS TUF Gaming F15 Fx506lhb-hn359.php" method="post" class="formprod">
