    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'ASUS TUF Gaming F15 FX506HE-HN012'";
            ...
            <form action="ASUS TUF Gaming F15 FX506HE-HN012.php" method="post" class="formprod">
