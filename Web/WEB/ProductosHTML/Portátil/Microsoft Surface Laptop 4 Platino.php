    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'Microsoft Surface Laptop 4 Platino'";
            ...
            <form action="Microsoft Surface Laptop 4 Platino.php" method="post" class="formprod">
