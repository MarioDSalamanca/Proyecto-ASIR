...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Portátiles-Gaming.php" method="post">
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Portátiles where función like 'Gaming'";
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    $query = "select * from Portátiles where función like 'Gaming' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query = "select * from Portátiles where función like 'Gaming' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    $query = "select * from Portátiles where función like 'Gaming' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query = "select * from Portátiles where función like 'Gaming' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
