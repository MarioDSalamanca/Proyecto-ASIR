...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Móviles.php" method="post">
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="Apple" class="empresas"> iPhone</p>
                            <p><input type="radio" name="empresa" value="Samsung" class="empresas"> Samsung</p>
                            <p><input type="radio" name="empresa" value="Xiaomi" class="empresas"> Xiaomi</p>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    $query = "select * from Móviles where empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query = "select * from Móviles where precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    $query = "select * from Móviles where empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query = "select * from Móviles where precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
