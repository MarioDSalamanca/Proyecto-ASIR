    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Móviles where nombre like 'Xiaomi Mi 10T Lite'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="Móviles.php">&#10150;</a></p>
            <form action="Xiaomi Mi 10T Lite.php" method="post" class="formprod">
                <input type="hidden" name="tabla" value="<?php echo $bbdd['tabla']; ?>">
                <input type='text' class='tituloprod' name='nombre' value="<?php echo $bbdd['nombre']; ?>" readonly>
                <hr width="80%" class="hr">
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Móvil/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
                    <div class="divproductos">
                        ...
                        <p class="coloresprod">
                            <strong>Almacenamiento</strong> <i>(500 GB por defecto)</i>:
                        </p>
                        <div class="botonescoloresprod">
                            <input type="radio" name="almacenamiento" id="almacenamiento500" value="500 GB" checked>
                            <label for="almacenamiento500" class="almacenamiento">500 GB</label>
                            <input type="radio" name="almacenamiento" id="almacenamiento1" value="1 TB">
                            <label for="almacenamiento1" class="almacenamiento">1 TB</label>
                            <input type="radio" name="almacenamiento" id="almacenamiento2" value="2 TB">
                            <label for="almacenamiento2" class="almacenamiento">2 TB</label>
                        </div>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Galaxy Z Flip4.php"><img src="../../Fotos_Productos/Móvil/Galaxy Z Flip4.jpg" class="imgsimilares">
                        <p class="prodsimilares">Galaxy Z Flip4</p></a>
                    </td>
                    <td>
                        <a href="IPhone 14 Pro Max.php"><img src="../../Fotos_Productos/Móvil/IPhone 14 Pro Max.jpg" class="imgsimilares">
                        <p class="prodsimilares">IPhone 14 Pro Max</p></a>
                    </td>
                    <td>
                        <a href="Xiaomi 12T Pro.php"><img src="../../Fotos_Productos/Móvil/Xiaomi 12T Pro.jpg" class="imgsimilares">
                        <p class="prodsimilares">Xiaomi 12T Pro</p></a>
                    </td>
                    <td>
                        <a href="Redmi Note 11 Pro.php"><img src="../../Fotos_Productos/Móvil/Redmi Note 11 Pro.jpg" class="imgsimilares">
                        <p class="prodsimilares">Redmi Note 11 Pro</p></a>
                    </td>
                </tr>
            </table>
        </main>
