    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Cooler Master Cosmos C700P Black Edition'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <form action="Cooler Master Cosmos C700P Black Edition.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Chasis/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Tempest Spectra.php"><img src="../../Fotos_Productos/Chasis/Tempest Spectra.jpg" class="imgsimilares">
                        <p class="prodsimilares">Tempest Spectra</p></a>
                    </td>
                    <td>
                        <a href="Seasonic Syncro Q704.php"><img src="../../Fotos_Productos/Chasis/Seasonic Syncro Q704.jpg" class="imgsimilares">
                        <p class="prodsimilares">Seasonic Syncro Q704</p></a>
                    </td>
                    <td>
                        <a href="ASUS TUF Gaming GT501VC.php"><img src="../../Fotos_Productos/Chasis/ASUS TUF Gaming GT501VC.jpg" class="imgsimilares">
                        <p class="prodsimilares">ASUS TUF Gaming GT501VC</p></a>
                    </td>
                    <td>
                        <a href="Corsair iCUE 5000X.php"><img src="../../Fotos_Productos/Chasis/Corsair iCUE 5000X.jpg" class="imgsimilares">
                        <p class="prodsimilares">Corsair iCUE 5000X</p></a>
                    </td>
                </tr>
            </table>
        </main>
