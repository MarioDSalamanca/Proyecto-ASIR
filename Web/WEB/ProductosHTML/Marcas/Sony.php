...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Sony.php" method="post">
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='" . $bbdd['nombre'] . ".php'><img src='./Sony/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                        ...
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from $empresa where empresa like 'Sony' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query= "select nombre, empresa, precio, imagen from (select nombre, empresa, precio, imagen from Componentes union select nombre, empresa, precio, imagen from Consolas union select nombre, empresa, precio, imagen from TVs union select nombre, empresa, precio, imagen from PCs union select nombre, empresa, precio, imagen from Portátiles union select nombre, empresa, precio, imagen from Móviles) as resultado where empresa like 'Sony' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from $empresa where empresa like 'Sony' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query= "select nombre, empresa, precio, imagen from (select nombre, empresa, precio, imagen from Componentes union select nombre, empresa, precio, imagen from Consolas union select nombre, empresa, precio, imagen from TVs union select nombre, empresa, precio, imagen from PCs union select nombre, empresa, precio, imagen from Portátiles union select nombre, empresa, precio, imagen from Móviles) as resultado where empresa like 'Sony' order by precio";
                                }
                            }
