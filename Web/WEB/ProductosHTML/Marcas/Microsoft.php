...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Microsoft.php" method="post">
                <table class="tablafilter" width="80%">
                    <input type="button" value="Borrar" onclick="reset()" class="reset">
                        <th class="thfiltros">Filtros</th>
                    <tr>
                        <td>
                            <p class="pfilter">Precio: <input type="number" name="precio1" class="filtroprecio" placeholder="10"> - 
                    ...
                    <tr>
                        <td>
                            <div class="marcas">Familia:
                            <p><input type="radio" name="empresa" value="Componentes" class="empresas"> Componente</p>
                            <p><input type="radio" name="empresa" value="Consolas" class="empresas"> Consola</p>
                            <p><input type="radio" name="empresa" value="Portátiles" class="empresas"> Portátil</p>
                            </div>
                        </td>
                    </tr>
                    </tr>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select nombre, empresa, precio, imagen from (select nombre, empresa, precio, imagen from Componentes union select nombre, empresa, precio, imagen from Consolas union select nombre, empresa, precio, imagen from TVs union select nombre, empresa, precio, imagen from PCs union select nombre, empresa, precio, imagen from Portátiles union select nombre, empresa, precio, imagen from Móviles) as resultado where empresa like 'Microsoft'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='" . $bbdd['nombre'] . ".php'><img src='./Microsoft/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                        ...
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from $empresa where empresa like 'Microsoft' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query= "select nombre, empresa, precio, imagen from (select nombre, empresa, precio, imagen from Componentes union select nombre, empresa, precio, imagen from Consolas union select nombre, empresa, precio, imagen from TVs union select nombre, empresa, precio, imagen from PCs union select nombre, empresa, precio, imagen from Portátiles union select nombre, empresa, precio, imagen from Móviles) as resultado where empresa like 'Microsoft' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from $empresa where empresa like 'Microsoft' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query= "select nombre, empresa, precio, imagen from (select nombre, empresa, precio, imagen from Componentes union select nombre, empresa, precio, imagen from Consolas union select nombre, empresa, precio, imagen from TVs union select nombre, empresa, precio, imagen from PCs union select nombre, empresa, precio, imagen from Portátiles union select nombre, empresa, precio, imagen from Móviles) as resultado where empresa like 'Microsoft' order by precio";
                                }
                            }
