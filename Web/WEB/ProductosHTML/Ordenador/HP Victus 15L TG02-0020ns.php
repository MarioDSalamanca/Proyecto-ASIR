    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from PCs where nombre like 'HP Victus 15L TG02-0020ns'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Ordenador/PCs.php">&#10150;</a></p>
            <form action="HP Victus 15L TG02-0020ns.php" method="post" class="formprod">
