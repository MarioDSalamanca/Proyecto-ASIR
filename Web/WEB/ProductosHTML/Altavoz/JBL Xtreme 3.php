    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'JBL Xtreme 3'";
            ...
            <form action="JBL Xtreme 3.php" method="post" class="formprod">
            ...
            <table class="similares">
                ...
                <tr>
                    ...
                    <td>
                        <a href=".JBL Xtreme 3.php"><img src="../../Fotos_Productos/Altavoz/JBL Xtreme 3.jpg" class="imgsimilares">
                        <p class="prodsimilares">JBL Xtreme 3</p></a>
                    </td>
                    <td>
