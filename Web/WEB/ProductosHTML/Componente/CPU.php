                ...
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="intel" class="empresas"> Intel</p>
                            <p><input type="radio" name="empresa" value="amd" class="empresas"> Amd</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'CPU'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Procesador/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                        ...
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'CPU' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'CPU' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'CPU' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'CPU' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Procesador/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/Componentes/Comun/CPU/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
