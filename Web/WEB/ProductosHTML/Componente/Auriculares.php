...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Auriculares.php" method="post">
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="cisco" class="empresas"> Cisco</p>
                            <p><input type="radio" name="empresa" value="apple" class="empresas"> Apple</p>
                            <p><input type="radio" name="empresa" value="sony" class="empresas"> Sony</p>
                            <p><input type="radio" name="empresa" value="razer" class="empresas"> Razer</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'Auricular'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Auricular/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                        ...
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'Auricular' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'Auricular' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'Auricular' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'Auricular' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
