...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Carcasas.php" method="post">
                <table class="tablafilter" width="80%">
                    <input type="button" value="Borrar" onclick="reset()" class="reset">
                        <th class="thfiltros">Filtros</th>
                    <tr>
                        <td>
                            <p class="pfilter">Precio: <input type="number" name="precio1" class="filtroprecio" placeholder="0"> - 
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="modelo" value="Carcasa-ATX" class="empresas"> ATX</p>
                            <p><input type="radio" name="modelo" value="Carcasa-EATX" class="empresas"> EATX</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="asus" class="empresas"> Asus</p>
                            <p><input type="radio" name="empresa" value="corsair" class="empresas"> Corsarir</p>
                            <p><input type="radio" name="empresa" value="tempest" class="empresas"> Tempest</p>
                            <p><input type="radio" name="empresa" value="nfortec" class="empresas"> Nfortec</p>
                            <p><input type="radio" name="empresa" value="cooler master" class="empresas"> Cooler Master</p>
                            <p><input type="radio" name="empresa" value="phanteks" class="empresas"> Phanteks</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'Carcasa%'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Chasis/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($modelo)) {
                                    if (!empty($empresa)) {
                                        ...
                                        $query = "select * from Componentes where tipo like '$modelo' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    else {

                                        $query = "select * from Componentes where tipo like '$modelo' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                }
                                else {
                                    if (!empty($empresa)) {

                                        $query = "select * from Componentes where tipo like 'Carcasa%' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    else {

                                        $query = "select * from Componentes where tipo like 'Carcasa%' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($modelo)) {
                                    if (!empty($empresa)) {
                                        ...
                                        $query = "select * from Componentes where tipo like '$modelo' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    else {

                                        $query = "select * from Componentes where tipo like '$modelo' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                }
                                else {
                                    if (!empty($empresa)) {

                                        $query = "select * from Componentes where tipo like 'Carcasa%' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    else {

                                        $query = "select * from Componentes where tipo like 'Carcasa%' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                }
                            }
