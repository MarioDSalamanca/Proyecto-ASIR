    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Kingston Data Center DC450R 7.68TB'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Ud.Almacenamiento.php">&#10150;</a></p>
            <form action="Kingston Data Center DC450R 7.68TB.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Almacenamiento/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Kingston DC500M 3.84TB.php"><img src="../../Fotos_Productos/Almacenamiento/Kingston DC500M 3.84TB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Kingston DC500M 3.84TB</p></a>
                    </td>
                    <td>
                        <a href="Gigabyte AORUS RAID 2TB.php"><img src="../../Fotos_Productos/Almacenamiento/Gigabyte AORUS RAID 2TB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Gigabyte AORUS RAID 2TB</p></a>
                    </td>
                    <td>
                        <a href="MSI Spatium M450 1TB.php"><img src="../../Fotos_Productos/Almacenamiento/MSI Spatium M450 1TB.jpg" class="imgsimilares">
                        <p class="prodsimilares">MSI Spatium M450 1TB</p></a>
                    </td>
                    <td>
                        <a href="Crucial P5 Plus 500GB.php"><img src="../../Fotos_Productos/Almacenamiento/Crucial P5 Plus 500GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Crucial P5 Plus 500GB</p></a>
                    </td>
                </tr>
            </table>
        </main>
