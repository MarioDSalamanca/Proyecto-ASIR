...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Ud.Almacenamiento.php" method="post">
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="number" name="precio2" class="filtroprecio" placeholder="5000"></p>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="modelo" value="HDD" class="empresas"> HDD</p>
                            <p><input type="radio" name="modelo" value="SSD" class="empresas"> SSD</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="kingston" class="empresas"> Kingston</p>
                            <p><input type="radio" name="empresa" value="seagate" class="empresas"> Seagate</p>
                            <p><input type="radio" name="empresa" value="wd" class="empresas"> WD</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'HDD' or tipo like 'SSD'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Almacenamiento/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($modelo)) {
                                    ...
                                    if (!empty($empresa)) {
                                        ...
                                        $query = "select * from Componentes where tipo like 'HDD' and empresa like '$empresa' or tipo like 'SSD' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    else {

                                        $query = "select * from Componentes where tipo like 'HDD' or tipo like 'SSD' and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($modelo)) {
                                    ...
                                    if (!empty($empresa)) {
                                        ...
                                        $query = "select * from Componentes where tipo like 'HDD' and empresa like '$empresa' or tipo like 'SSD' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    else {

                                        $query = "select * from Componentes where tipo like 'HDD' or tipo like 'SSD' and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                }
                            }
