...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Teclados.php" method="post">
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value="logitech" class="empresas"> Logitech</p>
                            <p><input type="radio" name="empresa" value="%" class="empresas"> Otros</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tipo like 'Teclado'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../Teclado/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                        ...
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'Teclado' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'Teclado' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    ...
                                    $query = "select * from Componentes where tipo like 'Teclado' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {

                                    $query = "select * from Componentes where tipo like 'Teclado' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
