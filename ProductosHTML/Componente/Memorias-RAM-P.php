...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./Memorias-RAM-P.php" method="post">
                <table class="tablafilter" width="80%">
                    <input type="button" value="Borrar" onclick="reset()" class="reset">
                        <th class="thfiltros">Filtros</th>
                    <tr>
                        <td>
                            <p class="pfilter">Precio: <input type="number" name="precio1" class="filtroprecio" placeholder="20"> - 
                    ...
                    <tr>
                        <td>
                            ...
                            <p><input type="radio" name="empresa" value=" 4%" class="empresas"> 4GB</p>
                            <p><input type="radio" name="empresa" value="%8%" class="empresas"> 8GB</p>
                            <p><input type="radio" name="empresa" value="%16%" class="empresas"> 16GB</p>
                            <p><input type="radio" name="empresa" value="%32%" class="empresas"> 32GB</p>
                            <p><input type="radio" name="empresa" value="%64%" class="empresas"> 64GB</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Componentes where tabla like 'SO-DIMM'";
                            ...
                            if ($rows > 0) {
                                ...
                                for ($i = 0; $i < $rows; $i++) {
                                    ...
                                    echo "<div class='contenido'>";
                                        echo "<a href='../SO-DIMM/" . $bbdd['nombre'] . ".php'><img src='../../Fotos_Productos/".$bbdd['tabla']."/" . $bbdd['imagen'] . "' class='imagenescontenido'>";
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    $query = "select * from Componentes where tabla like 'SO-DIMM' and right(nombre, 4) like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query = "select * from Componentes where tabla like 'SO-DIMM' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    $query = "select * from Componentes where tabla like 'SO-DIMM' and right(nombre, 4) like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query = "select * from Componentes where tabla like 'SO-DIMM' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
