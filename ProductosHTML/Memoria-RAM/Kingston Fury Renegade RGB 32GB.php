    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Kingston Fury Renegade RGB 32GB'";
            ...
            <form action="Kingston Fury Renegade RGB 32GB.php" method="post" class="formprod">
