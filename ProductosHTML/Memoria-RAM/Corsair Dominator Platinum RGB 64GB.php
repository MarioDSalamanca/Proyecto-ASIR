    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Corsair Dominator Platinum RGB 64GB'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Memorias-RAM-O.php">&#10150;</a></p>
            <form action="Corsair Dominator Platinum RGB 64GB.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Memoria-RAM/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Crucial Ballistix Max RGB 32GB.php"><img src="../../Fotos_Productos/Memoria-RAM/Crucial Ballistix Max RGB 32GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Crucial Ballistix Max RGB 32GB</p></a>
                    </td>
                    <td>
                        <a href="Kingston Fury Renegade RGB 32GB.php"><img src="../../Fotos_Productos/Memoria-RAM/Kingston Fury Renegade RGB 32GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Kingston Fury Renegade RGB 32GB</p></a>
                    </td>
                    <td>
                        <a href="Crucial CTI6G4DFD832A 16GB.php"><img src="../../Fotos_Productos/Memoria-RAM/Crucial CTI6G4DFD832A 16GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Crucial CTI6G4DFD832A 16GB</p></a>
                    </td>
                    <td>
                        <a href="Corsair Vengeance RGB RS 64GB.php"><img src="../../Fotos_Productos/Memoria-RAM/Corsair Vengeance RGB RS 64GB.jpg" class="imgsimilares">
                        <p class="prodsimilares">Corsair Vengeance RGB RS 64GB</p></a>
                    </td>
                </tr>
            </table>
        </main>
