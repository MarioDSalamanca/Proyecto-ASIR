    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'ASUS Chromebook Flip CX5 CB5400FMA'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="Portátiles.php">&#10150;</a></p>
            <form action="ASUS Chromebook Flip CX5 CB5400FMA.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Portátil/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="HP ZBook Studio G8.php"><img src="../../Fotos_Productos/Portátil/HP ZBook Studio G8.jpg" class="imgsimilares">
                        <p class="prodsimilares">HP ZBook Studio G8</p></a>
                    </td>
                    <td>
                        <a href="Microsoft Surface Pro X.php"><img src="../../Fotos_Productos/Portátil/Microsoft Surface Pro X.jpg" class="imgsimilares">
                        <p class="prodsimilares">Microsoft Surface Pro X</p></a>
                    </td>
                    <td>
                        <a href="Apple MacBook Pro.php"><img src="../../Fotos_Productos/Portátil/Apple MacBook Pro.jpg" class="imgsimilares">
                        <p class="prodsimilares">Apple MacBook Pro</p></a>
                    </td>
                    <td>
                        <a href="ASUS F1500EA-BQ2364W.php"><img src="../../Fotos_Productos/Portátil/ASUS F1500EA-BQ2364W.jpg" class="imgsimilares">
                        <p class="prodsimilares">ASUS F1500EA-BQ2364W</p></a>
                    </td>
                </tr>
            </table>
        </main>
