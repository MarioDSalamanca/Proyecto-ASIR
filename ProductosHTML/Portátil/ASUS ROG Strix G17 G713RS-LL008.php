    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Portátiles where nombre like 'ASUS ROG Strix G17 G713RS-LL008'";
            ...
            <form action="ASUS ROG Strix G17 G713RS-LL008.php" method="post" class="formprod">
