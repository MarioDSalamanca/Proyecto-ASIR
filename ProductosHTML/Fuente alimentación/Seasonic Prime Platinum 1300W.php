    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Seasonic Prime Platinum 1300W'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/FA.php">&#10150;</a></p>
            <form action="Seasonic Prime Platinum 1300W.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Fuente alimentación/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Aerocool LUX1000 1000W.php"><img src="../../Fotos_Productos/Fuente alimentación/Aerocool LUX1000 1000W.jpg" class="imgsimilares">
                        <p class="prodsimilares">Aerocool LUX1000 1000W</p></a>
                    </td>
                    <td>
                        <a href="Seasonic Prime Platinum 1300W.php"><img src="../../Fotos_Productos/Fuente alimentación/Seasonic Prime Platinum 1300W.jpg" class="imgsimilares">
                        <p class="prodsimilares">Seasonic Prime Platinum 1300W</p></a>
                    </td>
                    <td>
                        <a href="Gigabyte P450B 450W.php"><img src="../../Fotos_Productos/Fuente alimentación/Gigabyte P450B 450W.jpg" class="imgsimilares">
                        <p class="prodsimilares">Gigabyte P450B 450W</p></a>
                    </td>
                    <td>
                        <a href="Tempest PSU 750W.php"><img src="../../Fotos_Productos/Fuente alimentación/Tempest PSU 750W.jpg" class="imgsimilares">
                        <p class="prodsimilares">Tempest PSU 750W</p></a>
                    </td>
                </tr>
            </table>
        </main>
