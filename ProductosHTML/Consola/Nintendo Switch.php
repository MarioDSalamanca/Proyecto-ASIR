    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Consolas where nombre like 'Nintendo Switch'";
            ...
            <form action="Nintendo Switch.php" method="post" class="formprod">
            ...
            <table class="similares">
                ...
                <tr>
                    ...
                    <td>
                        <a href="Nintendo Switch.php"><img src="../../Fotos_Productos/Consola/Nintendo Switch.jpg" class="imgsimilares">
                        <p class="prodsimilares">Nintendo Switch</p></a>
                    </td>
                    <td>
