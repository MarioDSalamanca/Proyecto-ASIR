    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Kingston Fury Impact DDR5 32GB'";
            ...
            <form action="Kingston Fury Impact DDR5 32GB.php" method="post" class="formprod">
