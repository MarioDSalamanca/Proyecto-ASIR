    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Kingston Fury Impact DDR5 64GB'";
            ...
            <form action="Kingston Fury Impact DDR5 64GB.php" method="post" class="formprod">
