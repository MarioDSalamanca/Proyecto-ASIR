...
<html>
    ...
    <header>
            ...
            <div id="menudesplegable" onmouseleave="adiosmenu()">
                    ...
                    <div class="listamenu" id="listamenu6">
                        <table width="90%" height="60%" style="margin-top: 10%;">
                            ...
                            <tr>
                                <td>
                                    <a href="../../ProductosHTML/Televisión/TV32-56.php"><p class="submenu"><strong>Pulgadas 32" - 56"</strong></p></a>2
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <div id="filtros">
                ...
                <form action="./TVs.php" method="post">
                <table class="tablafilter" width="80%">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="number" name="precio2" class="filtroprecio" placeholder="6000"></p>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%">
                    ...
                    <tr>
                        <td>
                            <div class="marcas">Pulgadas:
                            <p><input type="radio" name="pulgada" value="30" class="empresas"> 30" - 56"</p>
                            <p><input type="radio" name="pulgada" value="57" class="empresas"> 57" - 76"</p>
                            <p><input type="radio" name="pulgada" value="77" class="empresas"> 77" - 86"</p>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($pulgada)) {
                                    if ($pulgada == '30') {
                                        $query = "select * from TVs where right(nombre, 6) between 30 and 56 and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    elseif ($pulgada == '57') {
                                        $query = "select * from TVs where right(nombre, 6) between 57 and 76 and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                    elseif ($pulgada == '77') {
                                        $query = "select * from TVs where right(nombre, 6) between 77 and 86 and precio between '$precio1' and '$precio2' order by precio desc";
                                    }
                                }
                                else {
                                    $query = "select * from TVs where precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            ...
                            elseif ($orden == '1') {
                                if (!empty($pulgada)) {
                                    if ($pulgada == '30') {
                                        $query = "select * from TVs where right(nombre, 6) between 30 and 56 and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    elseif ($pulgada == '57') {
                                        $query = "select * from TVs where right(nombre, 6) between 57 and 76 and precio between '$precio1' and '$precio2' order by precio";
                                    }
                                    elseif ($pulgada == '77') {
                                        $query = "select * from TVs where right(nombre, 6) between 77 and 86 and precio between '$precio1' and '$precio2' order by precio";
                                    }                                }
                                else {
                                    $query = "select * from TVs where precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
