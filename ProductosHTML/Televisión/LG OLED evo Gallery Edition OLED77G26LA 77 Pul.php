    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from TVs where nombre like 'LG OLED evo Gallery Edition OLED77G26LA 77 Pul'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="TVs.php">&#10150;</a></p>
            <form action="LG OLED evo Gallery Edition OLED77G26LA 77 Pul.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Televisión/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="./LG 86NANO766QA 86 Pul.php"><img src="../../Fotos_Productos/Televisión/LG 86NANO766QA 86 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">LG 86NANO766QA 86 Pul</p></a>
                    </td>
                    <td>
                        <a href="./Samsung UE65BU8000K 65 Pul.php"><img src="../../Fotos_Productos/Televisión/Samsung UE65BU8000K 65 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Samsung UE65BU8000K 65 Pul</p></a>
                    </td>
                    <td>
                        <a href="Philips 43PUS7406-12 43 Pul.php"><img src="../../Fotos_Productos/Televisión/Philips 43PUS7406-12 43 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Philips 43PUS7406-12 43 Pul</p></a>
                    </td>
                    <td>
                        <a href="Xiaomi Mi TV P1 32 Pul.php"><img src="../../Fotos_Productos/Televisión/Xiaomi Mi TV P1 32 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Xiaomi Mi TV P1 32 Pul</p></a>
                    </td>
                </tr>
            </table>
        </main>
...
<?php
        ...
        if (isset($_REQUEST['añadir']) &&  isset($_SESSION['correo'])) {
