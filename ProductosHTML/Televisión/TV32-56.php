...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./TV32-56.php" method="post">
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from TVs where right(nombre, 6) between 32 and 56";
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                $query = "select * from TVs where right(nombre, 6) between 32 and 56 and precio between '$precio1' and '$precio2' order by precio desc";
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                $query = "select * from TVs where right(nombre, 6) between 32 and 56 and precio between '$precio1' and '$precio2' order by precio";
                            }
