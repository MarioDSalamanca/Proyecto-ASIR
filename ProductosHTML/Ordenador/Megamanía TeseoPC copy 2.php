    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from PCs where nombre like 'Megamanía TeseoPC'";
            ...
            <form action="Megamanía TeseoPC.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Ordenador/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="./PcVIP Élite.php"><img src="../../Fotos_Productos/Ordenador/PcVIP Élite.jpg" class="imgsimilares">
                        <p class="prodsimilares">PcVIP Élite</p></a>
                    </td>
                    <td>
                        <a href="./HP Victus 15L TG02-0020ns.php"><img src="../../Fotos_Productos/Ordenador/HP Victus 15L TG02-0020ns.jpg" class="imgsimilares">
                        <p class="prodsimilares">HP Victus 15L TG02-0020ns</p></a>
                    </td>
                    <td>
                        <a href="PcCom Studio.php"><img src="../../Fotos_Productos/Ordenador/PcCom Studio.jpg" class="imgsimilares">
                        <p class="prodsimilares">PcCom Studio</p></a>
                    </td>
                    <td>
                        <a href="Lenovo V55T Gen 2-13ACN.php"><img src="../../Fotos_Productos/Ordenador/Lenovo V55T Gen 2-13ACN.jpg" class="imgsimilares">
                        <p class="prodsimilares">Lenovo V55T Gen 2-13ACN</p></a>
                    </td>
                </tr>
            </table>
        </main>
