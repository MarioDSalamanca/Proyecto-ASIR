...
<html>
    ...
    <header>
            ...
            <div id="filtros">
                ...
                <form action="./PC-WorkStation.php" method="post">
                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from PCs where función like 'WorkStation'";
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                if (!empty($empresa)) {
                                    $query = "select * from PCs where función like 'WorkStation' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                                else {
                                    $query = "select * from PCs where función like 'WorkStation' and precio between '$precio1' and '$precio2' order by precio desc";
                                }
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                if (!empty($empresa)) {
                                    $query = "select * from PCs where función like 'WorkStation' and empresa like '$empresa' and precio between '$precio1' and '$precio2' order by precio";
                                }
                                else {
                                    $query = "select * from PCs where función like 'WorkStation' and precio between '$precio1' and '$precio2' order by precio";
                                }
                            }
