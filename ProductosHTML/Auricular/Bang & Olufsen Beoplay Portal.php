    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'Bang & Olufsen Beoplay Portal'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Auriculares.php">&#10150;</a></p>
            <form action="Bang & Olufsen Beoplay Portal.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Auricular/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="./JVC XP-EXTI.php"><img src="../../Fotos_Productos/Auricular/JVC XP-EXTI.jpg" class="imgsimilares">
                        <p class="prodsimilares">JVC XP-EXTI</p></a>
                    </td>
                    <td>
                        <a href="./Apple AirPods Pro 2ªG.php"><img src="../../Fotos_Productos/Auricular/Apple AirPods Pro 2ªG.jpg" class="imgsimilares">
                        <p class="prodsimilares">Apple AirPods Pro 2ªG</p></a>
                    </td>
                    <td>
                        <a href="Razer Kraken V3 Pro.php"><img src="../../Fotos_Productos/Auricular/Razer Kraken V3 Pro.jpg" class="imgsimilares">
                        <p class="prodsimilares">Razer Kraken V3 Pro</p></a>
                    </td>
                    <td>
                        <a href="JBL Free II.php"><img src="../../Fotos_Productos/Auricular/JBL Free II.jpg" class="imgsimilares">
                        <p class="prodsimilares">JBL Free II</p></a>
                    </td>
                </tr>
            </table>
        </main>
