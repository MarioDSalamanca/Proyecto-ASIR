                ...
                <?php
                    ...
                    # Sin filtros
                        if (!isset($_REQUEST['aplicar'])) {
                            ...
                            # Consulta
                                $query = "select * from Móviles where empresa like 'Apple'";
                    ...
                    # Con filtros
                        if (isset($_REQUEST['aplicar'])) {
                            ...
                            if ($orden == '0' && ($precio1 < $precio2)) {
                                $query = "select * from Móviles where empresa like 'Apple' and precio between '$precio1' and '$precio2' order by precio desc";
                            }
                            # Orden por Más barato
                            elseif ($orden == '1') {
                                $query = "select * from Móviles where empresa like 'Apple' and precio between '$precio1' and '$precio2' order by precio";
                            }
