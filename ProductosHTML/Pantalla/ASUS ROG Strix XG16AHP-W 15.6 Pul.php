    ...
    <body>
        ...
        <main id="main">
                <?php
                    ...
                    # Consulta
                        $query = "select * from Componentes where nombre like 'ASUS ROG Strix XG16AHP-W 15.6 Pul'";
                    ...
                    # Ejecutar consulta
                        ...
                        $bbdd = mysqli_fetch_array($consulta);
                ?>
            <p class="flecha"><a href="../Componente/Monitores.php">&#10150;</a></p>
            <form action="ASUS ROG Strix XG16AHP-W 15.6 Pul.php" method="post" class="formprod">
                ...
                <div class="producto">
                        <?php
                            echo "<img src='../../Fotos_Productos/Pantalla/" . $bbdd['imagen'] . "' class='imgprod'>";
                        ?>
            ...
            <table class="similares">
                ...
                <tr>
                    <td>
                        <a href="Dell U4616DW 49 Pul.php"><img src="../../Fotos_Productos/Pantalla/Dell U4616DW 49 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Dell U4616DW 49 Pul</p></a>
                    </td>
                    <td>
                        <a href="ASUS ProArt PA329C 32 Pul.php"><img src="../../Fotos_Productos/Pantalla/ASUS ProArt PA329C 32 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">ASUS ProArt PA329C 32 Pul</p></a>
                    </td>
                    <td>
                        <a href="MSI MPG Artymis 343CQRDE 34 Pul.php"><img src="../../Fotos_Productos/Pantalla/MSI MPG Artymis 343CQRDE 34 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">MSI MPG Artymis 343CQRDE 34 Pul</p></a>
                    </td>
                    <td>
                        <a href="Samsung Odissey G7 28 Pul.php"><img src="../../Fotos_Productos/Pantalla/Samsung Odissey G7 28 Pul.jpg" class="imgsimilares">
                        <p class="prodsimilares">Samsung Odissey G7 28 Pul</p></a>
                    </td>
                </tr>
            </table>
        </main>
